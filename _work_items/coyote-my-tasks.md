...
<section class="grid grid-cols-3 gap-10 pt-20">
	<div class="col-span-3 md:col-span-1">
		...
		<p class="mb-6">Adding an actionable sidebar increased the effort to complete this project considerably so we built the project in phases, allowing other projects and features to take priority in between.</p>
